<%@ Page Title="" Language="C#" MasterPageFile="~/BlogAdmin.master" AutoEventWireup="true" CodeFile="Post.aspx.cs" Inherits="Post" %>
                        ...
                        <div class="col-md-12 content-page">
                            ...
                            <div class="col-md-12 page-body margin-top-50 footer">
                                <ul class="knowledge">
                                    ...
                                    <a href="SinglePost.aspx"><li class="bg-color-5"><i class="fa fa-comment-o" style="font-size: 18px"></i><%# " " +  Eval("commentscount") %> </li></a>
